...
const EmployeeSettingsLayout = () => {
  ...
  const links = [
    { to: 'employee-settings-profile', label: 'Profile' },
    { to: 'employee-settings-locations', label: 'Locations & PINs' },
    { to: 'employee-settings-notifications', label: 'Notifications' },
    { to: 'employee-settings-passwordandsecurity', label: 'Password & Security' },
  ];
